...
been coding since i was 13, now building cool stuff

does : frontend (next.js or react), backend(node.js, python) , android development ( kotlin & flutter ) 


Projects done 
- https://yscroll.xyz , an android app built to save you time from doom scrolling
  - built in public gaining over 5 Million views while building
  - over 3.5K installs so far
...
[![X](https://img.shields.io/badge/X-6,090%20followers-black.svg?logo=X&logoColor=white)](https://x.com/imsanyidiriba)
[![YouTube](https://img.shields.io/badge/YouTube-7.97K%20subs-red.svg?logo=youtube&logoColor=white)](https://www.youtube.com/@Sanyi-Diriba)
